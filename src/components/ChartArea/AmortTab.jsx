  ...
  return (
    <Wrap>
      {activeKeys.map((k) => {
        ...
        const capDs = [
          { color: COL[k], label: t("amort.capital"), data: capData },
        ];
        ...
        return (
          <SimBlock key={k}>
            ...
            <ChartTitle
              dangerouslySetInnerHTML={{ __html: t("charts.amort.title") }}
            />
            <ChartDesc
              dangerouslySetInnerHTML={{ __html: t("charts.amort.desc") }}
            />
            <CanvasChart
            ...
            <ChartTitle
              dangerouslySetInnerHTML={{ __html: t("charts.amortCap.title") }}
            />
            <CanvasChart
