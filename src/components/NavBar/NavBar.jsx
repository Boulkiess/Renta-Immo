...
const Nav = styled.nav`
  ...
  height: 52px; display: flex; align-items: center; justify-content: space-between; padding: 0 18px;
  flex-shrink: 0;
`;
...
const BrandIcon = styled.div`
  ...
  background: #3b6fd4; display: grid; place-items: center; flex-shrink: 0;
`;

const Badge = styled.span`
  font-size: 9px; color: #a78bfa;
  background: rgba(167,139,250,.12); padding: 2px 7px; border-radius: 20px; font-weight: 700;
  letter-spacing: .1em; text-transform: uppercase; font-family: ${({ theme }) => theme.mono};
`;
...
const ActionBtn = styled.button`
  ...
  border-radius: 7px; color: ${({ $primary }) => $primary ? '#fff' : '#dce6f7'};
...
const ExpOpt = styled.button`
  ...
  color: #dce6f7; font-family: inherit; font-size: 12px; font-weight: 600;
  padding: 7px 12px; border-radius: 5px; cursor: pointer; text-align: left; white-space: nowrap;
...
const ThemeBtn = styled.button`
  ...
  background: transparent; cursor: pointer; color: #aebbd4; font-size: 14px;
  ...
  return (
    <Nav>
      ...
      <Actions>
        ...
        <ThemeBtn onClick={onToggleTheme} title={currentThemeName === 'dark' ? 'Mode clair' : 'Mode sombre'}>
